  ...
  return (
    <div className="p-2 mt-5 text-center max-h-screen overflow-auto">
      <div className="pic flex justify-center w-full">
        <Image
          src={"/image/mu_pic.png"}
          alt={""}
          height={0}
          width={0}
          className="w-12 sm:w-20 md:w-28 h-12 sm:h-20 md:h-28 rounded-full bg-slate-500 transition outline outline-orange-500"
          unoptimized
        ></Image>
      </div>
      ...
      <div className="options mt-[10vh]">
        <Link href={"/Main"} className={`home ${optionCss}`}>
          <i>
            <svg
        ...
        <Link href={"/Accomplishments"} className={`contact ${optionCss}`}>
          <i>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <p className="hidden sm:block ml-5">Accomplishments</p>
        </Link>
