    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg">
        ...
        <p className="mb-4 py-6">
          ...
          responsive user interfaces using HTML, CSS, and JavaScript, with a
          strong proficiency in modern frameworks like React, Next.js and
          Angular. On the back-end, I have solid experience with Node.js,
          Express, and databases such as MongoDB and MySQL. This blend of
