      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-0 md:flex-row md:gap-8">
        <div className="flex flex-col justify-center items-center h-[85%] md:h-full order-2 md:order-1 md:items-start">
          ...
          <p className="text-gray-300 py-4 max-x-md text-justify">
            Experienced Software Developer with a focus on Frontend Development
            and intermediate Backend skills, boasting over 2 years of industry
            experience. Proficient across multiple platforms, languages, and
            frameworks. Known for developing responsive and intuitive web
            applications with a keen emphasis on user experience. Additionally,
            possesses hands-on experience in API development.{" "}
          </p>
